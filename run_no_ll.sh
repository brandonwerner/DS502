...
echo "running male rate_no_ll"
Rscript cross_val_male_rate_no_ll.R >cross_val_male_rate_no_ll.txt
echo "running combined ratio _no_ll"
Rscript cross_val_combined_ratio_no_ll.R  >cross_val_combined_ratio_no_ll.txt  
echo "running female ratio"
Rscript cross_val_female_ratio_no_ll.R  >cross_val_female_ratio_no_ll.txt  
echo "running male ratio"
Rscript cross_val_male_ratio_no_ll.R >cross_val_male_ratio_no_ll.txt
echo "done"
...
git addcross_val*
git addfigures/*
git commit -m "scripts,results, and figures"
git push
